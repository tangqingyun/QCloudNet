...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="">
					...
					<ul class="sub-menu">
						<li><a href="List.aspx">Boxed Page</a></li>
		...
		<div class="page-content">
			<div class="container-fluid">
                <iframe src="List.aspx" name="iframepage" id="iframepage" frameborder="0" scrolling="auto" style="width: 100%; height:800px;"  marginheight="0" marginwidth="0" onLoad="iFrameHeight()"></iframe>
			</div>
		</div>
        <!-- END PAGE -->
...
jQuery(document).ready(function () {
    ...
    $("#iframepage").load(function () {
        ...
        if (ifm != null && subWeb != null) {
            ...
            ifm.width = subWeb.body.scrollWidth+"px";
            //$(this).attr("height", subWeb.body.scrollHeight);
        }
